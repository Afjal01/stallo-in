import { r as reactExports, j as jsxRuntimeExports, a as useSearch, S as Skeleton } from "./index-DIzWvAoP.js";
import { V as VendorCard } from "./VendorCard-Ci_Drmup.js";
import { R as RootLayout } from "./RootLayout-58N_cMmF.js";
import { B as Badge, X } from "./sheet-BeMLdLfo.js";
...
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion } from "./proxy-DxhnKv7e.js";
...
function BrowsePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(RootLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b border-border/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-4xl md:text-5xl mb-2", children: "Browse Food Stalls" }),
        ...
        motion.div,
        {
          ...
          children: CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `rounded-full px-4 py-1.5 text-xs font-medium border transition-all duration-200 flex items-center gap-1.5 ${category === cat ? "bg-primary text-primary-foreground border-primary shadow-sm" : "bg-card text-foreground border-border hover:border-primary/40 hover:bg-muted/50"}`,
