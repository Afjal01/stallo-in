import { l as clsx, R as React, m as getDefaultExportFromCjs, r as reactExports, g as dateToTimestamp, f as formatDate, j as jsxRuntimeExports, c as formatPrice, S as Skeleton } from "./index-BKL2lxtv.js";
import { D as DashboardLayout, S as ShoppingBag } from "./DashboardLayout-BbZ-GuY6.js";
import { B as Button, V as VendorStatus } from "./useAuth-IAGlSf5h.js";
import { C as Card, b as CardHeader, c as CardTitle, a as CardContent } from "./card-BTgr7EEz.js";
import { r as useAnalyticsSummary, w as useBookingsByDateRange, x as useRevenueByDateRange, u as useVendors } from "./useBackend-B1f4NLLV.js";
...
import { a as filterProps, _ as _baseExtremum, b as _baseGt, c as _baseIteratee, d as _baseLt, i as isFunction, e as Text, p as polarToCartesian, L as Layer, h as getTickClassName, j as adaptEventsOfChild, k as Label, D as Dot, l as Curve, m as isNil, n as getValueByDataKey, S as Shape, A as Animate, o as get, q as interpolateNumber, r as isEqual, s as isNumber, t as LabelList, u as uniqueId, G as Global, v as mathSign, w as findAllByType, x as Cell, y as getMaxRadius, z as getPercentValue, E as warn, g as generateCategoricalChart, F as formatAxisMap, R as ResponsiveContainer, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, H as Legend } from "./generateCategoricalChart-B9nQjxuo.js";
...
function KpiCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "glass-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-24 mt-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-primary", children: value })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg p-2.5 bg-primary/10 text-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "size-5" }) })
  ] }) }) });
}
function AdminAnalytics() {
  const [range, setRange] = reactExports.useState("30d");
  const days = RANGE_DAYS[range];
  const from = reactExports.useMemo(
    () => dateToTimestamp(new Date(Date.now() - days * 864e5)),
    [days]
  );
  const to = reactExports.useMemo(() => dateToTimestamp(/* @__PURE__ */ new Date()), []);
  const { data: summary, isLoading: sumLoading } = useAnalyticsSummary();
  const { data: bookingsByDate = [], isLoading: bookingsLoading } = useBookingsByDateRange(from, to);
  const { data: revenueByDate = [], isLoading: revenueLoading } = useRevenueByDateRange(from, to);
  const { data: vendors = [] } = useVendors({ status: VendorStatus.approved });
  const bookingChartData = [...bookingsByDate].map((d) => ({
    date: formatDate(d.date, { month: "short", day: "numeric" }),
    bookings: Number(d.count)
  })).sort((a, b) => a.date.localeCompare(b.date));
  const revenueChartData = [...revenueByDate].map((d) => ({
    date: formatDate(d.date, { month: "short", day: "numeric" }),
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              title: "Cancellations",
              value: sumLoading ? "—" : Number((summary == null ? void 0 : summary.cancelledBookings) ?? 0).toString(),
              icon: CircleX,
              loading: sumLoading
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold font-display", children: "Bookings Over Time" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold font-display", children: "Revenue Over Time (₹)" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-0", children: revenueLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              LineChart,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold font-display", children: "Vendors by Category" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-0", children: categoryData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48 flex items-center justify-center text-sm text-muted-foreground", children: "No data yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Pie,
                {
                  data: categoryData,
                  ...
                  children: categoryData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Cell,
                    {
                      fill: PIE_COLORS[categoryData.indexOf(entry) % PIE_COLORS.length]
                    },
                    entry.name
                  ))
                }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold font-display", children: "Top Vendors by Rating" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: topVendors.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-8 text-center text-sm text-muted-foreground", children: "No vendor data yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/40", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-left text-xs font-bold text-primary/60 uppercase tracking-widest text-[11px]", children: "Vendor" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-left text-xs font-bold text-primary/60 uppercase tracking-widest text-[11px] hidden sm:table-cell", children: "Category" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-right text-xs font-bold text-primary/60 uppercase tracking-widest text-[11px]", children: "Rating" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-right text-xs font-bold text-primary/60 uppercase tracking-widest text-[11px] hidden md:table-cell", children: "Reviews" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: topVendors.map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "tr",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: v.businessName }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: v.serviceArea })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden sm:table-cell", children: v.category }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-right font-semibold text-amber-600", children: [
                      v.rating.toFixed(1),
                      " ★"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right text-muted-foreground hidden md:table-cell", children: Number(v.reviewCount) })
                  ]
                },
                v.id
              )) })
