import { j as jsxRuntimeExports, S as Skeleton, L as Link, f as formatDate, c as formatPrice } from "./index-BKL2lxtv.js";
import { S as StatusBadge } from "./StatusBadge-BlMQRdya.js";
import { S as ShoppingBag, D as DashboardLayout } from "./DashboardLayout-BbZ-GuY6.js";
...
function CustomerDashboardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DashboardLayout,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl border border-primary/20 bg-primary/5 px-5 py-4 mb-6 flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold gold-gradient", children: "Welcome back!" }),
          ...
          Card,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-primary", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-10" }) : stat.value }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-xl text-primary", children: "Upcoming Bookings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "outline",
