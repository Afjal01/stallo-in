import { r as reactExports, j as jsxRuntimeExports, c as formatPrice, S as Skeleton, f as formatDate, t as timestampToDate } from "./index-BKL2lxtv.js";
...
import { c as createLucideIcon, u as useAuth, d as BookingStatus } from "./useAuth-IAGlSf5h.js";
import { u as useVendors, g as useBookings } from "./useBackend-B1f4NLLV.js";
import { T as TrendingUp } from "./trending-up-OZEtAFop.js";
import { I as IndianRupee } from "./indian-rupee-QwBQ8HUy.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12" }, i)) }) : completed.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-10 text-center", "data-ocid": "earnings.empty_state", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/60", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-6 py-3 text-xs font-semibold uppercase tracking-widest text-[11px] text-primary/60", children: "Event Date" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-xs font-semibold uppercase tracking-widest text-[11px] text-primary/60", children: "Guests" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-xs font-semibold uppercase tracking-widest text-[11px] text-primary/60", children: "Total" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-xs font-semibold uppercase tracking-widest text-[11px] text-primary/60", children: "Commission (10%)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-6 py-3 text-xs font-semibold uppercase tracking-widest text-[11px] text-primary/60", children: "Net Earnings" })
            ] }) }),
