import { b as useParams, r as reactExports, j as jsxRuntimeExports, S as Skeleton, e as calculateCancellationFee, L as Link, f as formatDate, c as formatPrice, h as ue } from "./index-DIzWvAoP.js";
...
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel } from "./alert-dialog-6qk2QkpM.js";
...
import { h as useBooking, i as useCancelBooking, j as useCreateReview } from "./useBackend-CUhkj_B6.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DashboardLayout, { title: "Booking Details", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-4xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-semibold", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary text-base", children: formatPrice(booking.totalPrice) })
            ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
        booking.bookingStatus !== BookingStatus.cancelled && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 space-y-3", children: [
        ...
        canCancel && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-amber-200 bg-amber-50 dark:bg-amber-900/10 dark:border-amber-800/30 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
