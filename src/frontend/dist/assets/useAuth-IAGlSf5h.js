...
const VendorBookingStat = Record({
  "revenue": Nat,
  "vendorId": VendorId,
  "vendorName": Text,
  "bookingCount": Nat
...
const AnalyticsSummary = Record({
  ...
  "totalBookings": Nat,
  "topVendors": Vec(VendorBookingStat),
...
Service({
  ...
  "getBookingsByDateRange": Func(
    [Timestamp, Timestamp, Opt(Text)],
    [Vec(DateRangeResult)],
    ["query"]
  ),
  "getCallerUserRole": Func([], [UserRole$1], ["query"]),
  "getCategoryBreakdown": Func(
    [],
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const VendorBookingStat2 = IDL2.Record({
    "revenue": IDL2.Nat,
    "vendorId": VendorId2,
  ...
  const AnalyticsSummary2 = IDL2.Record({
    ...
    "vendorPayouts": IDL2.Nat,
    "cancelledBookings": IDL2.Nat,
    "totalBookings": IDL2.Nat,
    "topVendors": IDL2.Vec(VendorBookingStat2),
  ...
  const CategoryBreakdown2 = IDL2.Record({
    "categoryId": IDL2.Text,
    "revenue": IDL2.Nat,
  ...
  const PagedBookings2 = IDL2.Record({
    "total": IDL2.Nat,
    "offset": IDL2.Nat,
    "limit": IDL2.Nat,
    "items": IDL2.Vec(Booking2)
  });
  ...
  const PagedVendors2 = IDL2.Record({
    "total": IDL2.Nat,
    "offset": IDL2.Nat,
    "limit": IDL2.Nat,
    "items": IDL2.Vec(Vendor2)
  });
  ...
  return IDL2.Service({
    ...
    "getBookingsByDateRange": IDL2.Func(
      [Timestamp2, Timestamp2, IDL2.Opt(IDL2.Text)],
      [IDL2.Vec(DateRangeResult2)],
      ["query"]
    ),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getCategoryBreakdown": IDL2.Func(
      [],
      [IDL2.Vec(CategoryBreakdown2)],
      ["query"]
    ),
    ...
    "listBookings": IDL2.Func(
      [BookingFilter2, IDL2.Nat, IDL2.Nat],
      [PagedBookings2],
      ["query"]
    ),
    ...
    "listVendors": IDL2.Func(
      [VendorFilter2, IDL2.Nat, IDL2.Nat],
      [PagedVendors2],
      ["query"]
    ),
...
class Backend {
  ...
  async getBookingsByDateRange(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async getRevenueByDateRange(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async listBookings(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async listVendors(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_ApprovalStatus_n41(_uploadFile, _downloadFile, value) {
...
function from_candid_PagedBookings_n47(_uploadFile, _downloadFile, value) {
  return from_candid_record_n48(_uploadFile, _downloadFile, value);
}
async function from_candid_PagedVendors_n54(_uploadFile, _downloadFile, value) {
...
function from_candid_StripeSessionStatus_n34(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n35(_uploadFile, _downloadFile, value);
}
function from_candid_UserApprovalInfo_n39(_uploadFile, _downloadFile, value) {
...
async function from_candid_record_n55(_uploadFile, _downloadFile, value) {
  return {
    total: value.total,
    offset: value.offset,
    limit: value.limit,
...
function to_candid_BookingFilter_n43(_uploadFile, _downloadFile, value) {
  return to_candid_record_n44(_uploadFile, _downloadFile, value);
}
function to_candid_BookingStatus_n45(_uploadFile, _downloadFile, value) {
...
async function to_candid_UpdateVendorRequest_n60(_uploadFile, _downloadFile, value) {
...
function to_candid_VendorFilter_n50(_uploadFile, _downloadFile, value) {
  return to_candid_record_n51(_uploadFile, _downloadFile, value);
}
function to_candid_VendorStatus_n52(_uploadFile, _downloadFile, value) {
...
async function to_candid_record_n61(_uploadFile, _downloadFile, value) {
  return {
    serviceArea: value.serviceArea ? candid_some(value.serviceArea) : candid_none(),
